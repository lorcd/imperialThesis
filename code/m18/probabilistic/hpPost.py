...
This specific hyperparameter file is for the posterior distributions experiments.
"""
import numpy as np
...
prior = "custom_multivariate_johnsonSUhalf_fn"
prior = "custom_multivariate_laplaceHalf_fn"
